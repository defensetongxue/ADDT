...
parser.add_argument('--dataset_root', type=str, default='E:/CS dataset/Anomaly Detection Dataset/BrainMRI', help="dataset root")
...
target_root = 'E:/CS dataset/Anomaly Detection Dataset/1.DRA pro-precess dataset//BrainMRI'
