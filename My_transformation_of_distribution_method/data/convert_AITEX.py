...
parser.add_argument('--dataset_root', type=str, default='E:/CS dataset/Anomaly Detection Dataset/AITEX', help="dataset root")
...
# print("outlier_root", outlier_root)
...
for image in files:
    ...
    # print(os.path.join(label_root, image_name + '_mask.png'))
...
target_root = 'E:/CS dataset/Anomaly Detection Dataset/1.DRA pro-precess dataset/AITEX'
