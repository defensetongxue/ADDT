from datasets import eyesight, mvtecad
...
class initDataloader():
    ...
    def build(args, **kwargs):
        if args.dataset == "eyesight":
            normal_set = eyesight.Eyesight(args, train_type="normal_set", train=True)
            train_set = eyesight.Eyesight(args, train_type="train_set", train=True)
            test_set = eyesight.Eyesight(args, train_type="test_set", train=False)
